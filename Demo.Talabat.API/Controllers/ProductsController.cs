...
namespace Demo.Talabat.API.Controllers
{
	public class ProductsController : BaseApiController
	{
		...
		//------------------------------ First Endpoints ----------------------------------------
		[HttpGet]
		public async Task<ActionResult<IReadOnlyList<ProductToReturnDto>>> GetProducts(string sort,int? brandId,int? categoryId) //we won't use the name of the method in the routing as we used to do in the MVC
		{
